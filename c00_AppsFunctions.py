...
def load_map(dataframe, col, zoom_level=7.5):
    """
    Parameters
    ----------
    ...
    fig = px.scatter_mapbox(
        ...
        size=col,
        zoom=zoom_level,
        range_color=[dataframe[col].min(), dataframe[col].max()],
...
def set_map(dataframe, geojson, options_list, dropdown_value, col):
    """
    Parameters
    ----------
    dataframe : pandas dataframe
    ...
    # load the base map
    fig = load_map(dataframe, col, zoom_level)
